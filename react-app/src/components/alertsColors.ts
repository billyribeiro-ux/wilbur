/**
 * Alerts Panel Color System - Microsoft Enterprise Pattern
 * Centralized color definitions for Alerts panel theming
 * Customize these colors to change the entire Alerts UI
 */

export const ALERTS_COLORS = {
  // Header Colors
  header: {
    background: '#3B82F6',        // Alerts header background
