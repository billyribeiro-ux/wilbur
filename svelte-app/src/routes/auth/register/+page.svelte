...
<div class="min-h-screen flex">
	<!-- Left Panel - Branding -->
	<div class="hidden lg:flex lg:flex-1 items-center justify-center bg-linear-to-br from-primary-900/30 via-surface-900 to-surface-950">
		<div class="max-w-lg text-center px-12">
			<div class="flex justify-center mb-8">
				<div class="flex h-24 w-24 items-center justify-center rounded-2xl bg-primary-500/20 backdrop-blur">
					<TrendUpIcon class="h-12 w-12 text-primary-400" weight="duotone" />
				</div>
			</div>
		...
		<div class="mx-auto w-full max-w-md">
			<a href="/" class="flex items-center gap-2 text-surface-400 hover:text-white transition mb-8">
				<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-primary-500">
					<TrendUpIcon class="h-6 w-6 text-white" weight="bold" />
				</div>
			...
			<form onsubmit={handleSubmit} class="mt-8 space-y-5">
				<div>
					...
					<div class="relative mt-2">
						<UserIcon class="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-surface-500" />
						<input
							id="displayName"
							type="text"
				...
				<div>
					...
					<div class="relative mt-2">
						<EnvelopeIcon class="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-surface-500" />
						<input
							id="email"
							type="email"
							bind:value={email}
				...
				<div>
					...
					<div class="relative mt-2">
						<LockIcon class="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-surface-500" />
						<input
							id="password"
